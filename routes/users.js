...
const userSchema = mongoose.Schema({
  ...
  friends: [{ type: mongoose.Schema.Types.ObjectId, ref: "d" }],
  pendingFriendRequests: [{ type: mongoose.Schema.Types.ObjectId, ref: "d" }],
  requestSent: [{ type: mongoose.Schema.Types.ObjectId, ref: "d" }],
});

userSchema.plugin(passportLocalMongoose);
module.exports = mongoose.model("d", userSchema);
